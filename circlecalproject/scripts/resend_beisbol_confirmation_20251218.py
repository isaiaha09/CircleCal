...
qs = Booking.objects.filter(service__slug='beisbol', start__date=target, start__hour=10)
...
if qs.exists():
    ...
    print('No booking found for 2025-12-18 10:00 with service slug beisbol')
